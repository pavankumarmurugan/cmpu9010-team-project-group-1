export const MESSAGES = {
  ...
  GROUP_MEMBERS: {
    CREATE: {
      ...
      ALREADY: 'ALREADY A MEMBER OF THE GROUP',
      SAME_USER: 'CANNOT ADD SELF AS MEMBER',
    },
    GET_ALL: {
  ...
  USER_LIKED_MODEL: {
    CREATE: {
      SUCCESS: 'SUCCESSFULLY CREATED USER LIKED MODEL',
      ALREADY_LIKED: 'USER ALREADY LIKED THIS MODEL',
    },
    GET_ALL: {
      SUCCESS: 'SUCCESSFULLY FETCHED USER LIKED MODELS',
    },
    DELETE: {
      SUCCESS: 'SUCCESSFULLY DELETED USER LIKED MODEL',
    },
  },
};
