...
// import { ImageUploader } from 'src/infrastructure/script/script-upload-images';
...
//     const uploadImages = new ImageUploader(
//       process.env.AWS_ACCESS_KEY_ID,
//       process.env.AWS_SECRET_ACCESS_KEY,
//       this.databaseService,
//     );
...
//     await uploadImages.uploadImagesToS3(imageFolderPath);
//     return;
//   }
// }
